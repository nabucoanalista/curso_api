...
app.MapGet("/configuration/database", (IConfiguration configuration) => {
    return Results.Ok($"{configuration["database:connection"]}/{configuration["database:port"]}"); //configuration["database:connection"] parara mostrar o servidor usa esse o atual mostra a porta
});
